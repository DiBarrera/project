...
// GET - REGISTRO
router.get('/signup', (req, res) => res.render('auth/signup', {currentUser: req.session.currentUser}));
...
router.get('/login', (req, res) => res.render('auth/login', {currentUser: req.session.currentUser}));
